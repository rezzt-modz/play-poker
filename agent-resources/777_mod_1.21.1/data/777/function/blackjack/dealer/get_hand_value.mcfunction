...
function 777:blackjack/click/execute_as_type_in_group_no_tag {type: "dealer_card_slot", cmd: "function 777:blackjack/card/get_value"}
...
execute if entity @s[tag=777.finish_hand] run function 777:blackjack/click/execute_as_type_in_group_no_tag {type: "dealer_hand_value", cmd: "function 777:blackjack/hand_value/set_text"}
